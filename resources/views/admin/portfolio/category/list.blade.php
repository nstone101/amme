                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{route('portfolioList')}}" class="btn btn-primary list-button px-3 mr-2">{{__('Portfolio')}}</a>
                            <a href="{{route('portfolioCategoryCreate')}}" class="btn list-add-button px-3">{{__('Add New')}}</a>
...
@section('script')
    <script>
        $('#table').DataTable({
            ...
            pageLength: 25,
            responsive: true,
            ajax: '{{route('portfolioCategoryList')}}',
            order: [3, 'desc'],
            autoWidth:false,
            columns: [
                {"data": "image"},
